<template>
  <div v-if="parsed" :data-theme="mode" :class="'markdown-body ' + classes" v-html="parsed"> </div>
</template>
...
export default {
  ...
  computed: {
      ...
      parsed()  {
        ...
        console.warn("empty content in markdown component!")
        return ""
      },
...
.markdown-body ul {
list-style-type: disc; /* Change to 'circle' or 'square' for different bullet styles */
}

.markdown-body ol {
list-style-type: decimal; /* Change to 'lower-alpha', 'upper-roman', etc. for different numbering styles */
}
