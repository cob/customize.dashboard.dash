...
#### 6.70.1
* Dashboard-v1:
Updates the `Home` dashboard instance: check the LabelCustomize `classes` checkbox and add a LabelClass 'invisible' to the Label component that has the content 'script:window.location.replace...'
